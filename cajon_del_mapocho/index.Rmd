...
Personalmente, armé esta ruta por que me encanta correr por los cerros, la ultradistancia y el desafío de la resistencia humana. Además soy de esta zona y muchos de estos hitos me conectan con mi historia, mis recuerdos, mi familia y mi territorio. 
...
Subiendo desde el campamento Doite ubicado en la base del andarivel las Aguilas del centro de Ski, se pasa por la laguna Piuquenes, y los cerros Falsa Parva, Parva y Pintor, para llegar a una extensa planicie de altura llamada Cancha de Carreras. Esta planicie tiene una meseta rectangular que la cultura popular tambien llama ovnipuerto, a 4150 msnm. 

### Campamento Federacion (Km 45.5)

Desde cancha de carreras sigue la ruta hacia la cumbre del cerro leonera, pero luego de un par de kilometros se alcanza el punto mas alto de la ruta 4200 (msnm) donde hay que tomar un desvio para comenzar a descender hacia el oriente, bajando por la falda del cerro Leonera hasta el campamento Federacion. Este campamento es la base del cerro el Plomo y suele ser frecuentado por montañistas durante la temporada de primeravera-verano. 

### Piedra numerada (Km 51)

El descenso continua desde Federacion hasta Piedra numerada, caracteristico hito de la cordillera que es un sector intermedio para los montañistas que visitan el cerro el Plomo, y se puede acceder desde Valle Nevado o La Parva. Este sector fue utilizado por los incas para como estacion de descanso en el camino hacia la cumbre del Plomo. En este trayecto aparece un afluente del rio Mapocho llamado estero del Cepo. 

### Refugio del Cepo (Km 63.5)

Si continua bajando por el rio cepo, luego de varios kilometros llega a un refugio de arrieros ubicado en la profundidad del cajon, en la orilla norte del rio. Este refugio se puede divisar desde el camino a Valle Nevado, y es uno de los pocos hitos de evidencia humana en este sector del valle. 

### La Ermita (Km 81.5)

Un poco mas abajo del refugio el rio Cepo se junta con otros afluentes para transformarse en el rio Molina, el cual hay que cruzar unas 7 veces antes de seguir por la ladera sur. En este tramo el cajon se va angostando y la ruta de los arrieros ancestrales fue optimizada con estos cruces del rio. En estos cruces es necesario llevar bastones debido a la fuerza del caudal. Luego de los cruces del rio se llega a Antahuaya, un centro de eventos en la montaña, para luego llegar a la Ermita, donde el rio Molina se junta con el rio San Francisco, para dar vida al rio Mapocho. La Ermita es el ultimo hito de la ruta, donde luego de 6 kilometros por un camino de tierra se llega de vuelta al punto de origen, el puente Ñilhue.
